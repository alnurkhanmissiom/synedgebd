...
import { initParticleEffect } from '../utils/particleEffect';
import {
  ArrowDownCircle,
  Code,
  Palette,
...
function Home() {
  useEffect(() => {
    initParticleEffect('header-canvas');
  }, []);
    ...
    <main>
      ...
      <section className="min-h-screen flex items-center justify-center pt-24 pb-16 px-4 md:px-8 bg-transparent">
        <div className="container mx-auto text-center">
          ...
          <Link
            to="#services"
            className="flex items-center justify-center space-x-2 bg-primary text-black text-lg px-8 py-3 rounded-full font-bold btn-primary hover:opacity-90 transition"
          >
      ...
      <section id="about" className="py-20 md:py-32 px-4 md:px-8 bg-gray-950">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-xl text-gray-400 leading-relaxed">
            SynEdge BD is a <strong>Bangladesh-based digital agency</strong>{' '}
            delivering impactful web and marketing solutions. Our team helps
            businesses expand their reach through technology and creativity,
            focusing on performance, scalability, and measurable growth for our
            clients.
          </p>
        </div>
      </section>
      ...
      <section id="contact" className="py-20 md:py-32 px-4 md:px-8">
        <div className="container mx-auto text-center max-w-3xl">
          ...
          <a
            ...
            className="inline-block bg-primary text-black text-lg px-10 py-4 rounded-full font-bold btn-primary hover:opacity-90 transition"
          >
